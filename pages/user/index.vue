          ...
          <view>
            <view class="">
              <view class="list_module">
                                                                <view v-if="$check_action('/registered_users/table','get')">
                          <navigator class="my_module" url="/pages/registered_users/table" hover-class="hover">
                            <div>
                              <text>注册用户</text>
                                                                                      ...
                                                                                      <view v-if="$check_action('/content_classification/table','get')">
                          <navigator class="my_module" url="/pages/content_classification/table" hover-class="hover">
                            <div>
                              <text>内容分类</text>
                            </div>
                          </navigator>
                        </view>
                                                                                      <view v-if="$check_action('/tree_hole_release/table','get')">
                          <navigator class="my_module" url="/pages/tree_hole_release/table" hover-class="hover">
                            <div>
                              <text>树洞发布</text>
                            </div>
                          </navigator>
                        </view>
                                                                                      <view v-if="$check_action('/content_reporting/table','get')">
                          <navigator class="my_module" url="/pages/content_reporting/table" hover-class="hover">
                            <div>
                              <text>内容举报</text>
                            </div>
                          </navigator>
