    ...
    async get_source_table_url(){
      ...
      if(json.result && json.result.obj){
        if (json.result.obj.source_table) {
          var json_sub = await this.$get("~/api/"+json.result.obj.source_table+"/get_obj?user_id="+this.$store.state.user.user_id);
          if(json_sub.result && json_sub.result.obj){
            this.source_table_url = "/pages/"+json.result.obj.source_table +"/view?"+json.result.obj.source_field+"=" + json_sub.result.obj[json.result.obj.source_field]
          }
        }
      }
    }
